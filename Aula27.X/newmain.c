/*
 Esqueleto de programa no pic18f4550
 Contém as bibliotecas de "delay_ms", "LCD" e "A/D".
 */
/*
vrm=5-vrf;
vrm=5-(rm.i);
...
5.adc/1024=5-rm.i;
irf=irm=(5-vrm)/rf;
5.adc/1024=5-rm.(5-vrm)/rf;
5.adc/1024-5=-rm(5-vrm)/rf;
-rf.((5.adc/1024)-5)=rm(5-vrm);
rm=-(rf).(5-vrm).((5.adc/1024)-5);
 */
